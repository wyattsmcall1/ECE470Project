...
if("FALSE" STREQUAL "TRUE")
  set(lab3_SOURCE_PREFIX /home/youbot/catkin_ws/src/lab3)
  set(lab3_DEVEL_PREFIX /home/youbot/catkin_ws/devel)
  set(lab3_INSTALL_PREFIX "")
  set(lab3_PREFIX ${lab3_DEVEL_PREFIX})
else()
  set(lab3_SOURCE_PREFIX "")
  set(lab3_DEVEL_PREFIX "")
  set(lab3_INSTALL_PREFIX /home/youbot/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'lab3' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'youbot <youbot@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'lab3' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/youbot/catkin_ws/install/${idir}'.  Ask the maintainer 'youbot <youbot@todo.todo>' to fix it.")
    endif()
