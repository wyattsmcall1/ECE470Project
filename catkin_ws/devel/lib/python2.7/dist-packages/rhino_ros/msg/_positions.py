...
"""autogenerated by genpy from rhino_ros/positions.msg. Do not edit."""
import sys
...
class positions(genpy.Message):
  _md5sum = "effceaa6d21d3d376be41978245bcf8f"
  _type = "rhino_ros/positions"
...
"""
  __slots__ = ['position','grip','at_position']
  _slot_types = ['int32[8]','int32','int32']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_2i.pack(_x.grip, _x.at_position))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.grip, _x.at_position,) = _struct_2i.unpack(str[start:end])
      return self
